...
export const required = (value) => {  
  return makeError(value, 'Required')
}
...
export const ipv4 = (value) => {
  if (value) {
    ...
    return makeError(reg.test(value), 'IPv4 Address Invalid')
  }
  return makeError()
}
...
export const ipv6 = (value) => {
  if (value) {
    ...
    return makeError(reg.test(value), 'IPv6 Address Invalid')
  }
  return makeError()
}
...
export const netmask = (value) => {
  if (value) {
    ...
    return makeError(longReg.test(value) || shortReg.test(value), 'Netmask Could Be Long Format Or Short Format')
  }
  return makeError()
}
